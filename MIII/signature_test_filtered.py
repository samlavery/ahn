...
ps = [
    ...
    257,
    65537,
    3001732422913219376338819698366525492620301042048305923969,
]
ws = [3, 11, 11, 13, 17, 19, 23]
################################################################
...
if True:
    ...
    # Reject secret vectors and challenges that have 0 value coefficients - inefficient brute force implementation
    ...
    for prog in range(0, test_runs):
        ...
        fs = list(
            (randbelow(ps[0])) for _ in range(n)
        )  # Fiat-Shamir challenge emulation
